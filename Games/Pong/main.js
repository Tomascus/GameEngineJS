...
drawRectangle(0,0,width,height,"#eee");
drawRectangle(0,player1Y, paddleWidth, paddleHeight, "black");
drawRectangle(width-paddleWidth, player2Y, paddleWidth, paddleHeight, "black");
